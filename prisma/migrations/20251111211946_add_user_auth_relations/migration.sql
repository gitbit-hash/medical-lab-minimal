...
-- AlterTable
ALTER TABLE "tests" ADD COLUMN     "created_by_id" TEXT,
...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
