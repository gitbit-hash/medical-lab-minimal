// app/[locale]/doctors/[id]/edit/doctor-edit-page-client.tsx
'use client';
...
interface DoctorEditPageClientProps {
  locale: string;
  initialData: DoctorFormData;
}

export function DoctorEditPageClient({ locale, initialData }: DoctorEditPageClientProps) {
  const t = useTranslations('EditDoctorPage');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(error || 'Failed to update doctor');
      }
    } catch (err) {
